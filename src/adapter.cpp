...
//DisplayAdapter::DisplayAdapter(DisplayManager dispMngr, World_Node_Ptr world_node, int height, int width,int y_corner, int x_corner)
//    :  node(world_node),
//    dispMngr(dispMngr),
...
void DisplayAdapter::update(){	// updates the content on the window, with updated content from the world_naode that is linked
