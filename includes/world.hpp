...
public:
	...
	// @note - ateFood() is expected NEVER to fail, based on the food_mutex, hence returns void
	...
	World();
	World( const State& prev_state );	// the world object doesn't need to be linked to parent node, that's handled by World_Node
