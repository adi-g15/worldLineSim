...
public:
	...
	directionalPath&& getPath(const Entity_Point& entity, Graph_Box<_box>& final_dest, bool shortest = false) = delete;	/** @not_implemented */
	...
	bool is_path_clean(const Graph_Box<_box>*, const directionalPath&) const;
...
private:
	...
	directionalPath&& shortest_path(const Entity_Point&, Graph_Box<_box>&) const;	/** @not_implemented */
	/*PATHFINDERS END*/
